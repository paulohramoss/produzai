// Server-side only — proprietary training methodology, never sent to the client bundle.
// Extracted from real physical preparation spreadsheets: "Chapinha" (gym for soccer athlete)
// and "Projeto 42km" (Elite Academy marathon periodization).
